...
Dali::UpdateProxy::NotifySyncPoint NotifyFrameCallback(Dali::Stage stage, FrameCallbackInterface& frameCallback)
{
  return GetImplementation(stage).NotifyFrameCallback(frameCallback);
}
