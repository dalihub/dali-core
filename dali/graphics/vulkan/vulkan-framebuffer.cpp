                                                                 ...
                                                                 vk::ClearDepthStencilValue clearDepthStencilValue )
{
  ...
  auto attachment = new FramebufferAttachment( std::move( imageView ), clearDepthStencilValue );
