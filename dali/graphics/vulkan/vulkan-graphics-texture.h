...
using TextureRef = Handle<class Texture>;
...
public:
   ...
   * @return
   */
  static TextureRef New( Graphics& graphics, uint32_t width, uint32_t height, vk::Format format );
...
private:
  ...
  explicit Texture( Graphics& graphcis , uint32_t width, uint32_t height, vk::Format format );
