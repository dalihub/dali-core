...
public:
   ...
   * @return
   */
  const CommandBuffer& GetCommandBuffer( int index ) const
  {
  ...
  // more detailed frame control flow
...
void SwapchainImpl::FramebufferBegin()
{

}

void SwapchainImpl::RenderPassBegin()
{

}

void SwapchainImpl::RenderPassEnd()
{

}

void SwapchainImpl::FramebufferEnd()
{
...
void SwapchainImpl::GetSwapchainImages()
{
  ...
  for(auto& buffer : mBuffers)
  {
    ...
    VkAssertCall(device.createImageView(&ivInfo, mDevice.GetVkAllocator(), &buffer.imageView));

    // create framebuffer
    attachments[0] = buffer.imageView;
    fbInfo.setPAttachments(attachments);
    VkAssertCall(device.createFramebuffer(&fbInfo, mDevice.GetVkAllocator(), &buffer.framebuffer));
...
const CommandBuffer& Swapchain::GetCommandBuffer( int index ) const
{
...
void Swapchain::FramebufferBegin()
{

}

void Swapchain::RenderPassBegin()
{

}

void Swapchain::RenderPassEnd()
{

}

void Swapchain::FramebufferEnd()
{
