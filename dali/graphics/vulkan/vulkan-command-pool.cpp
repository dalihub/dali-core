...
struct CommandBufferPool
{
  ...
  : mOwner( owner ), mGraphics( graphics ), mFirstFree(INVALID_NODE_INDEX), mAllocationCount( 0u ), mCapacity( initialCapacity ), mDefaultIncrease( defaultIncrease ), mIsPrimary( isPrimary )
  {
