...
bool Texture::GetFormatLinearDrmModifier(VkFormat format, VkDrmFormatModifierPropertiesEXT &outMode)
{
  std::vector<VkDrmFormatModifierPropertiesEXT> drm_format_modifiers;

  VkDrmFormatModifierPropertiesListEXT mod_props = {
      VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_LIST_EXT,// VkStructureType                      sType;
      nullptr, 						     //void*                                pNext;
  ...
  vkGetPhysicalDeviceFormatProperties2KHR(GetPhysicalDevice(), format, &format_props);
