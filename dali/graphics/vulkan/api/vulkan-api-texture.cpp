...
void Texture::BlitMemory( const void* srcMemory, API::Extent2D srcExtent, API::Offset2D dstOffset, uint32_t layer, uint32_t level )
{
  mImpl->BlitMemory( srcMemory, srcExtent, dstOffset, layer, level );
}

void Texture::BlitTexture( const API::Texture& srcTexture, API::Rect2D srcRegion, API::Offset2D dstOffset, uint32_t layer, uint32_t level )
{
  mImpl->BlitTexture( srcTexture, srcRegion, dstOffset, layer, level );
}

void Texture::BlitBuffer( const API::Buffer& srcBuffer, API::Extent2D srcExtent, API::Offset2D dstOffset, uint32_t layer, uint32_t level )
{
