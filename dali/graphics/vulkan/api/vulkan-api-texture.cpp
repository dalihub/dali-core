...
bool Texture::CreateSamplerYUVNativeImage()
{
    ...
    fprintf(stderr,"<<---------VkSamplerYcbcrConversionCreateInfoKHR Information--------->>\n");
    fprintf(stderr,"sType %d, pNext %p, format %d\n", conv_create_info.sType, conv_create_info.pNext, conv_create_info.format);
    fprintf(stderr,"ycbcrModel %d, ycbcrRange %d\n", conv_create_info.ycbcrModel, conv_create_info.ycbcrRange);
    fprintf(stderr,"components.r %d, g %d\n", conv_create_info.components.r, conv_create_info.components.g);
    fprintf(stderr,"components.b %d, a %d\n", conv_create_info.components.b, conv_create_info.components.a);
    fprintf(stderr,"xChromaOffset %d, yChromaOffset %d\n", conv_create_info.xChromaOffset, conv_create_info.yChromaOffset);
    fprintf(stderr,"chromaFilter %d, forceExplicitReconstruction %d\n", conv_create_info.chromaFilter, conv_create_info.forceExplicitReconstruction);
    fprintf(stderr,"<<------------------------------------------>>\n");
   ...
   if (VK_SUCCESS != gCreateSamplerYcbcrConversionKHR ( static_cast<VkDevice>(mGraphics.GetDevice()), &conv_create_info, nullptr, &mYcbcrConv))
   {
     ...
     fprintf(stderr,"Could not create vkCreateSamplerYcbcrConversionKHR !\n");
     return false;
   }
  ...
  fprintf(stderr,"<<---------VkSamplerCreateInfo Information--------->>\n");
  fprintf(stderr,"sType %d, pNext %p, flag %d\n", sampler_create_info->sType, sampler_create_info->pNext, sampler_create_info->flags);
  fprintf(stderr,"magFilter %d, minFilter %d, mipmapMode %d\n", sampler_create_info->magFilter, sampler_create_info->minFilter, sampler_create_info->mipmapMode);
  fprintf(stderr,"addressModeU %d, addressModeV %d, addressModeW %d\n", sampler_create_info->addressModeU, sampler_create_info->addressModeV, sampler_create_info->addressModeW);

  fprintf(stderr,"mipLodBias %lf\n", static_cast<double>(sampler_create_info->mipLodBias));
  fprintf(stderr,"anisotropyEnable %d\n", sampler_create_info->anisotropyEnable);
  fprintf(stderr,"maxAnisotropy %lf\n", static_cast<double>(sampler_create_info->maxAnisotropy));


  fprintf(stderr,"addressModeU %d, addressModeV %d, addressModeW %d\n", sampler_create_info->addressModeU, sampler_create_info->addressModeV, sampler_create_info->addressModeW);
  fprintf(stderr,"compareEnable %d, compareOp %d\n", sampler_create_info->compareEnable, sampler_create_info->compareOp);
  fprintf(stderr,"minLod %lf, maxLod %lf\n", static_cast<double>(sampler_create_info->minLod), static_cast<double>(sampler_create_info->maxLod));

  fprintf(stderr,"borderColor %d, unnormalizedCoordinates %d\n", sampler_create_info->borderColor, sampler_create_info->unnormalizedCoordinates);
  fprintf(stderr,"<<------------------------------------------>>\n");
