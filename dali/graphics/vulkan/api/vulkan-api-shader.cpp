...
ShaderRef VulkanShader::GetShader( vk::ShaderStageFlagBits shaderStage ) const
{
  switch( shaderStage )
  {
...
VulkanShader& VulkanShader::DownCast( Dali::Graphics::API::Shader& shader )
{
  return *( dynamic_cast<VulkanShader*>( &shader ) );
}
