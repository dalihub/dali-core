...
{
  DALI_LOG_RELEASE_INFO("update surface rect in scene-graph, from width[%d], height[%d], to width[%d], height[%d]\n", mSurfaceRect.width, mSurfaceRect.height, rect.width, rect.height);
  mSurfaceRect = rect;
}
