...
public:
   ...
   */
  [[nodiscard]] Graphics::RenderPass* GetGraphicsRenderPass(Graphics::AttachmentLoadOp loadOp,
                                                            Graphics::AttachmentStoreOp storeOp) const
  {
   ...
   */
  [[nodiscard]] const auto& GetGraphicsRenderPassClearValues() const
  {
    return mClearValues;
  }
  ...
  void GetAvailableBuffers(Integration::DepthBufferAvailable& depthBufferAvailable,
                            Integration::StencilBufferAvailable& stencilBufferAvailable) const;
