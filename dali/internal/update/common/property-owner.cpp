...
void PropertyOwner::DisconnectFromSceneGraph(BufferIndex updateBufferIndex)
{
  ...
  mObservers.ForEach([this, updateBufferIndex, &removedObservers](PropertyOwner::Observer* key, const uint32_t& value)
  {
    auto returnValue = (*key).PropertyOwnerDisconnected(updateBufferIndex, *this);
