                                    ...
                                    bool isRenderingToFbo )
{
  ...
  DALI_ANNOTATE_BEGIN( 1, 0x00AA00CC, "ProcessGestures" );
  ...
  DALI_ANNOTATE_BEGIN( 1, 0x009500b3, "Reset" );
  ...
  DALI_ANNOTATE_BEGIN( 1, 0x007f099, "ProcessMessages" );
  ...
  if( updateScene || mImpl->previousUpdateScene )
  {
    DALI_ANNOTATE_BEGIN( 1, 0x006a0080, "AnimUpdate" );
    //Animate
    ...
    if( mImpl->renderersAdded )
    {
      ...
      DALI_ANNOTATE_BEGIN( 1, 0x0055066, "PrepareRenderers" );
      PrepareRenderers( bufferIndex );
      DALI_ANNOTATE_END( 1 );
      DALI_ANNOTATE_BEGIN( 1, 0x0040004D, "SubmitRenderInstructions" );
