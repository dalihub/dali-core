...
// Message queue handling
   ...
   */
  void SetFilterMode( SceneGraph::Sampler* sampler, unsigned int minFilterMode, unsigned int magFilterMode );
   ...
   */
  void SetWrapMode( SceneGraph::Sampler* sampler, unsigned int rWrapMode, unsigned int sWrapMode, unsigned int tWrapMode );
   ...
   */
  void AddPropertyBuffer( OwnerPointer< SceneGraph::PropertyBuffer >& propertryBuffer );
   ...
   */
  void UploadTexture( SceneGraph::Texture* texture, PixelDataPtr pixelData,
   ...
   * @param[in] texture The texture
   */
  void GenerateMipmaps( SceneGraph::Texture* texture );
...
inline void SetFilterModeMessage( UpdateManager& manager, SceneGraph::Sampler& sampler, unsigned int minFilterMode, unsigned int magFilterMode )
{
  typedef MessageValue3< UpdateManager, SceneGraph::Sampler*, unsigned int, unsigned int > LocalType;
...
inline void SetWrapModeMessage( UpdateManager& manager, SceneGraph::Sampler& sampler, unsigned int rWrapMode, unsigned int sWrapMode, unsigned int tWrapMode )
{
  typedef MessageValue4< UpdateManager, SceneGraph::Sampler*, unsigned int, unsigned int, unsigned int > LocalType;
...
inline void SetPropertyBufferFormat( UpdateManager& manager, SceneGraph::PropertyBuffer& propertyBuffer, OwnerPointer< SceneGraph::PropertyBuffer::Format>& format )
{
  // Message has ownership of PropertyBuffer::Format while in transit from event -> update
  typedef MessageValue2< UpdateManager, SceneGraph::PropertyBuffer*, OwnerPointer< SceneGraph::PropertyBuffer::Format> > LocalType;
...
inline void SetPropertyBufferData( UpdateManager& manager, SceneGraph::PropertyBuffer& propertyBuffer, OwnerPointer< Vector<char> >& data, size_t size )
{
  // Message has ownership of PropertyBuffer data while in transit from event -> update
  typedef MessageValue3< UpdateManager, SceneGraph::PropertyBuffer*, OwnerPointer< Vector<char> >, size_t  > LocalType;
...
inline void AttachVertexBufferMessage( UpdateManager& manager, SceneGraph::Geometry& geometry, const SceneGraph::PropertyBuffer& vertexBuffer )
{
  typedef MessageValue2< UpdateManager, SceneGraph::Geometry*, SceneGraph::PropertyBuffer* > LocalType;

  // Reserve some memory inside the message queue
  unsigned int* slot = manager.ReserveMessageSlot( sizeof( LocalType ) );

  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &manager, &UpdateManager::AttachVertexBuffer, &geometry, const_cast<SceneGraph::PropertyBuffer*>(&vertexBuffer) );
}

inline void RemoveVertexBufferMessage( UpdateManager& manager, SceneGraph::Geometry& geometry, const SceneGraph::PropertyBuffer& vertexBuffer )
{
  typedef MessageValue2< UpdateManager, SceneGraph::Geometry*, SceneGraph::PropertyBuffer* > LocalType;
  ...
  // Construct message in the message queue memory; note that delete should not be called on the return value
  new (slot) LocalType( &manager, &UpdateManager::RemoveVertexBuffer, &geometry, const_cast<SceneGraph::PropertyBuffer*>(&vertexBuffer) );
}
...
public:
   ...
   */
  IndexBufferMessage( T* manager, SceneGraph::Geometry* geometry, Dali::Vector<unsigned short>& indices )
  : MessageBase(),
    mManager( manager ),
...
private:
  ...
  T* mManager;
  SceneGraph::Geometry* mRenderGeometry;
  Dali::Vector<unsigned short> mIndices;
};

inline void SetIndexBufferMessage( UpdateManager& manager, SceneGraph::Geometry& geometry, Dali::Vector<unsigned short>& indices )
{
...
inline void SetGeometryTypeMessage( UpdateManager& manager, SceneGraph::Geometry& geometry, unsigned int geometryType )
{
  typedef MessageValue2< UpdateManager, SceneGraph::Geometry*, unsigned int > LocalType;
...
inline void AddTexture( UpdateManager& manager, OwnerPointer< SceneGraph::Texture >& texture )
{
...
inline void RemoveTexture( UpdateManager& manager, SceneGraph::Texture& texture )
{
...
inline void UploadTextureMessage( UpdateManager& manager, SceneGraph::Texture& texture, PixelDataPtr pixelData, const Internal::Texture::UploadParams& params )
{
  typedef MessageValue3< UpdateManager, SceneGraph::Texture*, PixelDataPtr, Internal::Texture::UploadParams > LocalType;
...
inline void GenerateMipmapsMessage( UpdateManager& manager, SceneGraph::Texture& texture )
{
  typedef MessageValue1< UpdateManager, SceneGraph::Texture*  > LocalType;
