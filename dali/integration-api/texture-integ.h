 ...
 *
 * @param[in] texture The texture to set size.
 * @param[in] width The width of texture to set.
 * @param[in] height The height of texture to set.
 */
DALI_CORE_API void SetTextureSize(Dali::Texture texture, uint16_t width, uint16_t height);
