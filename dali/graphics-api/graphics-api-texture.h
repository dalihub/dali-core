...
public:
   ...
   */
  virtual void CopyMemory(const void *srcMemory, Extent2D srcExtent, Offset2D dstOffset, uint32_t layer, uint32_t level) = 0;
   ...
   */
  virtual void CopyTexture(const Texture &srcTexture, Rect2D srcRegion, Offset2D dstOffset, uint32_t layer, uint32_t level) = 0;
   ...
   * @param level Mipmap level
   */
  virtual void CopyBuffer(const API::Buffer &srcBuffer, API::Extent2D srcExtent, API::Offset2D dstOffset, uint32_t layer, uint32_t level) = 0;
