...
Actor CreateActorWithContent(uint32_t width, uint32_t height)
{
  ...
  actor.SetProperty(Actor::Property::SIZE, Vector2(static_cast<float>(width), static_cast<float>(height)));
...
int UtcDaliActorCalculateCurrentScreenExtents(void)
{
  ...
  expectedExtent = Bounds(3.0f, 1.0f, 2.0f, 4.0f);
  actualExtent   = DevelActor::CalculateCurrentScreenExtents(actor);
  DALI_TEST_EQUALS(expectedExtent.x, actualExtent.x, Math::MACHINE_EPSILON_10000, TEST_LOCATION);
  DALI_TEST_EQUALS(expectedExtent.y, actualExtent.y, Math::MACHINE_EPSILON_10000, TEST_LOCATION);
  DALI_TEST_EQUALS(expectedExtent.width, actualExtent.width, Math::MACHINE_EPSILON_10000, TEST_LOCATION);
...
int UtcDaliActorCalculateScreenInCustomCameraAndOffscreenLayer3D(void)
{
  ...
  auto expectedExtent = Bounds{sceneSize.x * 0.5f + sourcePosition.x - sourceSize.x * 0.5f,
  ...
  expectedExtent = Bounds{sceneSize.x * 0.5f + rootPosition.x + (sourcePosition.x - sourceSize.x * 0.5f) * rootSize.x / sceneSize.x,
...
int UtcDaliActorSetOrientation01(void)
{
  ...
  DALI_TEST_EQUALS(rotation, actor.GetCurrentProperty<Quaternion>(Actor::Property::ORIENTATION), 0.001f, TEST_LOCATION);
  END_TEST;
}
...
int UtcDaliActorSetOrientation02(void)
{
  ...
  application.SendNotification();
  application.Render();
  DALI_TEST_EQUALS(result, actor.GetCurrentProperty<Quaternion>(Actor::Property::ORIENTATION), 0.001f, TEST_LOCATION);
...
int UtcDaliActorSetOrientationProperty(void)
{
  ...
  actor.SetProperty(Actor::Property::ORIENTATION, rotation);
  DALI_TEST_EQUALS(rotation, actor.GetProperty<Quaternion>(Actor::Property::ORIENTATION), 0.001f, TEST_LOCATION);
...
int UtcDaliActorRotateBy01(void)
{
  ...
  application.SendNotification();
  application.Render();
  DALI_TEST_EQUALS(Quaternion(angle, Vector3::ZAXIS), actor.GetCurrentProperty<Quaternion>(Actor::Property::ORIENTATION), 0.001f, TEST_LOCATION);
  ...
  application.SendNotification();
  application.Render();
  DALI_TEST_EQUALS(Quaternion(angle * 2.0f, Vector3::ZAXIS), actor.GetCurrentProperty<Quaternion>(Actor::Property::ORIENTATION), 0.001f, TEST_LOCATION);
...
int UtcDaliActorGetCurrentWorldOrientation(void)
{
  ...
  DALI_TEST_EQUALS(parent.GetCurrentProperty<Quaternion>(Actor::Property::WORLD_ORIENTATION), Quaternion(Radian(0.0f), Vector3::YAXIS), 0.001f, TEST_LOCATION);
  DALI_TEST_EQUALS(child.GetCurrentProperty<Quaternion>(Actor::Property::WORLD_ORIENTATION), Quaternion(Radian(0.0f), Vector3::YAXIS), 0.001f, TEST_LOCATION);

  application.SendNotification();
  application.Render(0);

  DALI_TEST_EQUALS(parent.GetCurrentProperty<Quaternion>(Actor::Property::ORIENTATION), rotation, 0.001f, TEST_LOCATION);
  DALI_TEST_EQUALS(child.GetCurrentProperty<Quaternion>(Actor::Property::ORIENTATION), rotation, 0.001f, TEST_LOCATION);

  // The actors should have a world rotation now
  DALI_TEST_EQUALS(parent.GetCurrentProperty<Quaternion>(Actor::Property::WORLD_ORIENTATION), Quaternion(rotationAngle, Vector3::YAXIS), 0.001f, TEST_LOCATION);
  DALI_TEST_EQUALS(child.GetCurrentProperty<Quaternion>(Actor::Property::WORLD_ORIENTATION), Quaternion(rotationAngle * 2.0f, Vector3::YAXIS), 0.001f, TEST_LOCATION);
  ...
  // The actors should have a world rotation now
  DALI_TEST_EQUALS(parent.GetCurrentProperty<Quaternion>(Actor::Property::WORLD_ORIENTATION), Quaternion(rotationAngle, Vector3::YAXIS), 0.001f, TEST_LOCATION);
  DALI_TEST_EQUALS(child.GetCurrentProperty<Quaternion>(Actor::Property::WORLD_ORIENTATION), rotation, 0.001f, TEST_LOCATION);
  END_TEST;
}
...
int UtcDaliActorSetScale02(void)
{
  ...
  application.SendNotification();
  application.Render();
  DALI_TEST_EQUALS(Vector3(2.0f, 2.0f, 2.0f), actor.GetCurrentProperty<Vector3>(Actor::Property::SCALE), 0.001f, TEST_LOCATION);
...
int UtcDaliActorGetCurrentWorldMatrix(void)
{
  ...
  DALI_TEST_EQUALS(parent.GetCurrentProperty<Matrix>(Actor::Property::WORLD_MATRIX), parentMatrix, 0.001f, TEST_LOCATION);
  DALI_TEST_EQUALS(child.GetCurrentProperty<Matrix>(Actor::Property::WORLD_MATRIX), childWorldMatrix, 0.001f, TEST_LOCATION);
  END_TEST;
}
...
int UtcDaliActorConstrainedToWorldMatrix(void)
{
  ...
  DALI_TEST_EQUALS(parent.GetCurrentProperty<Matrix>(Actor::Property::WORLD_MATRIX), parentMatrix, 0.001f, TEST_LOCATION);
  DALI_TEST_EQUALS(child.GetCurrentProperty<Vector3>(Actor::Property::POSITION), parent.GetCurrentProperty<Vector3>(Actor::Property::POSITION), 0.001f, TEST_LOCATION);
  END_TEST;
}
...
int UtcDaliActorConstrainedToOrientation(void)
{
  ...
  DALI_TEST_EQUALS(child.GetCurrentProperty<Quaternion>(Actor::Property::ORIENTATION), parent.GetCurrentProperty<Quaternion>(Actor::Property::ORIENTATION), 0.001f, TEST_LOCATION);
  END_TEST;
}
...
const PropertyStringIndex PROPERTY_TABLE[] =
  {
    ...
    {"sizeModeFactor", DevelActor::Property::SIZE_MODE_FACTOR, Property::VECTOR3},
    {"widthResizePolicy", DevelActor::Property::WIDTH_RESIZE_POLICY, Property::STRING},
    {"heightResizePolicy", DevelActor::Property::HEIGHT_RESIZE_POLICY, Property::STRING},
    {"sizeScalePolicy", DevelActor::Property::SIZE_SCALE_POLICY, Property::INTEGER},
    {"widthForHeight", DevelActor::Property::WIDTH_FOR_HEIGHT, Property::BOOLEAN},
    {"heightForWidth", DevelActor::Property::HEIGHT_FOR_WIDTH, Property::BOOLEAN},
    {"padding", DevelActor::Property::PADDING, Property::VECTOR4},
    {"minimumSize", DevelActor::Property::MINIMUM_SIZE, Property::VECTOR2},
    {"maximumSize", DevelActor::Property::MAXIMUM_SIZE, Property::VECTOR2},
...
int UtcDaliRelayoutProperties_ResizePolicies(void)
{
  ...
  // Defaults
  DALI_TEST_EQUALS(actor.GetProperty(DevelActor::Property::WIDTH_RESIZE_POLICY).Get<String>(), "USE_NATURAL_SIZE", TEST_LOCATION);
  ...
  actor.SetProperty(DevelActor::Property::WIDTH_RESIZE_POLICY, widthPolicy);
  actor.SetProperty(DevelActor::Property::HEIGHT_RESIZE_POLICY, heightPolicy);

  DALI_TEST_EQUALS(actor.GetProperty(DevelActor::Property::WIDTH_RESIZE_POLICY).Get<String>(), widthPolicy, TEST_LOCATION);
  DALI_TEST_EQUALS(actor.GetProperty(DevelActor::Property::HEIGHT_RESIZE_POLICY).Get<String>(), heightPolicy, TEST_LOCATION);
...
int UtcDaliRelayoutProperties_SizeScalePolicy(void)
{
  ...
  // Defaults
  DALI_TEST_EQUALS(actor.GetProperty<SizeScalePolicy::Type>(DevelActor::Property::SIZE_SCALE_POLICY), SizeScalePolicy::USE_SIZE_SET, TEST_LOCATION);

  SizeScalePolicy::Type policy = SizeScalePolicy::FILL_WITH_ASPECT_RATIO;
  actor.SetProperty(DevelActor::Property::SIZE_SCALE_POLICY, policy);
  DALI_TEST_EQUALS(actor.GetProperty<SizeScalePolicy::Type>(DevelActor::Property::SIZE_SCALE_POLICY), policy, TEST_LOCATION);
  ...
  actor.SetProperty(DevelActor::Property::SIZE_SCALE_POLICY, policy1);
  DALI_TEST_EQUALS(actor.GetProperty<SizeScalePolicy::Type>(DevelActor::Property::SIZE_SCALE_POLICY), policy1, TEST_LOCATION);

  actor.SetProperty(DevelActor::Property::SIZE_SCALE_POLICY, policy2);
  DALI_TEST_EQUALS(actor.GetProperty<SizeScalePolicy::Type>(DevelActor::Property::SIZE_SCALE_POLICY), policy2, TEST_LOCATION);
...
int UtcDaliRelayoutProperties_SizeModeFactor(void)
{
  ...
  // Defaults
  DALI_TEST_EQUALS(actor.GetProperty(DevelActor::Property::SIZE_MODE_FACTOR).Get<Vector3>(), Vector3(1.0f, 1.0f, 1.0f), TEST_LOCATION);
  DALI_TEST_EQUALS(actor.GetProperty<Vector3>(DevelActor::Property::SIZE_MODE_FACTOR), Vector3(1.0f, 1.0f, 1.0f), TEST_LOCATION);

  Vector3 sizeMode(1.0f, 2.0f, 3.0f);
  actor.SetProperty(DevelActor::Property::SIZE_MODE_FACTOR, sizeMode);
  DALI_TEST_EQUALS(actor.GetProperty<Vector3>(DevelActor::Property::SIZE_MODE_FACTOR), sizeMode, TEST_LOCATION);

  // Set
  Vector3 sizeMode1(2.0f, 3.0f, 4.0f);

  actor.SetProperty(DevelActor::Property::SIZE_MODE_FACTOR, sizeMode1);
  DALI_TEST_EQUALS(actor.GetProperty(DevelActor::Property::SIZE_MODE_FACTOR).Get<Vector3>(), sizeMode1, TEST_LOCATION);
...
int UtcDaliRelayoutProperties_DimensionDependency(void)
{
  ...
  // Defaults
  DALI_TEST_EQUALS(actor.GetProperty(DevelActor::Property::WIDTH_FOR_HEIGHT).Get<bool>(), false, TEST_LOCATION);
  DALI_TEST_EQUALS(actor.GetProperty(DevelActor::Property::HEIGHT_FOR_WIDTH).Get<bool>(), false, TEST_LOCATION);

  // Set
  actor.SetProperty(DevelActor::Property::WIDTH_FOR_HEIGHT, true);
  DALI_TEST_EQUALS(actor.GetProperty(DevelActor::Property::WIDTH_FOR_HEIGHT).Get<bool>(), true, TEST_LOCATION);

  actor.SetProperty(DevelActor::Property::HEIGHT_FOR_WIDTH, true);
  DALI_TEST_EQUALS(actor.GetProperty(DevelActor::Property::HEIGHT_FOR_WIDTH).Get<bool>(), true, TEST_LOCATION);

  // Test setting another resize policy
  actor.SetProperty(DevelActor::Property::WIDTH_RESIZE_POLICY, "FIXED");
  DALI_TEST_EQUALS(actor.GetProperty(DevelActor::Property::WIDTH_FOR_HEIGHT).Get<bool>(), false, TEST_LOCATION);
...
int UtcDaliRelayoutProperties_Padding(void)
{
  ...
  // PADDING
  actor.SetProperty(DevelActor::Property::PADDING, padding);
  Vector4 paddingResult = actor.GetProperty(DevelActor::Property::PADDING).Get<Vector4>();
...
int UtcDaliRelayoutProperties_MinimumMaximumSize(void)
{
  ...
  Vector2 resultMin = actor.GetProperty(DevelActor::Property::MINIMUM_SIZE).Get<Vector2>();
  ...
  Vector2 resultMax = actor.GetProperty(DevelActor::Property::MAXIMUM_SIZE).Get<Vector2>();
...
int UtcDaliActorSetPadding(void)
{
  ...
  Vector4 padding;
  padding = actor.GetProperty<Vector4>(DevelActor::Property::PADDING);
  ...
  actor.SetProperty(DevelActor::Property::PADDING, padding2);
...
int UtcDaliActorSetMinimumSize(void)
{
  ...
  Vector2 size = actor.GetProperty<Vector2>(DevelActor::Property::MINIMUM_SIZE);

  DALI_TEST_EQUALS(size.width, 0.0f, TEST_LOCATION);
  DALI_TEST_EQUALS(size.height, 0.0f, TEST_LOCATION);

  Vector2 size2(1.0f, 2.0f);
  actor.SetProperty(DevelActor::Property::MINIMUM_SIZE, size2);

  size = actor.GetProperty<Vector2>(DevelActor::Property::MINIMUM_SIZE);
...
int UtcDaliActorSetMaximumSize(void)
{
  ...
  Vector2 size = actor.GetProperty<Vector2>(DevelActor::Property::MAXIMUM_SIZE);

  DALI_TEST_EQUALS(size.width, FLT_MAX, TEST_LOCATION);
  DALI_TEST_EQUALS(size.height, FLT_MAX, TEST_LOCATION);

  Vector2 size2(1.0f, 2.0f);
  actor.SetProperty(DevelActor::Property::MAXIMUM_SIZE, size2);

  size = actor.GetProperty<Vector2>(DevelActor::Property::MAXIMUM_SIZE);
  ...
  */
  ...
  for(int i = 0; i < 5; ++i)
  {
    ...
    else
    {
      ...
      actor.SetProperty(Actor::Property::PARENT_ORIGIN, Vector3(0.5f + (0.2f * b), 0.8f, 0.8f));
    }
...
int UtcDaliActorPropertyScissorClippingActorSiblings(void)
{
  ...
  Actor clippingActorA = CreateActorWithContent(static_cast<uint32_t>(sizeA.width), static_cast<uint32_t>(sizeA.height));
  Actor clippingActorB = CreateActorWithContent(static_cast<uint32_t>(sizeB.width), static_cast<uint32_t>(sizeB.height));
...
int UtcDaliActorPropertyScissorClippingActorNested02(void)
{
  ...
  */
  ...
  Actor clippingActorA = CreateActorWithContent(static_cast<uint32_t>(sizeA.width), static_cast<uint32_t>(sizeA.height));
  Actor clippingActorB = CreateActorWithContent(static_cast<uint32_t>(sizeB.width), static_cast<uint32_t>(sizeB.height));
  Actor clippingActorC = CreateActorWithContent(static_cast<uint32_t>(sizeC.width), static_cast<uint32_t>(sizeC.height));
  Actor clippingActorD = CreateActorWithContent(static_cast<uint32_t>(sizeD.width), static_cast<uint32_t>(sizeD.height));
  Actor clippingActorE = CreateActorWithContent(static_cast<uint32_t>(sizeE.width), static_cast<uint32_t>(sizeE.height));
...
int UtcDaliActorRaiseLower(void)
{
  ...
  actorA.SetProperty(DevelActor::Property::WIDTH_RESIZE_POLICY, "FILL_TO_PARENT");
  actorA.SetProperty(DevelActor::Property::HEIGHT_RESIZE_POLICY, "FILL_TO_PARENT");

  actorB.SetProperty(DevelActor::Property::WIDTH_RESIZE_POLICY, "FILL_TO_PARENT");
  actorB.SetProperty(DevelActor::Property::HEIGHT_RESIZE_POLICY, "FILL_TO_PARENT");

  actorC.SetProperty(DevelActor::Property::WIDTH_RESIZE_POLICY, "FILL_TO_PARENT");
  actorC.SetProperty(DevelActor::Property::HEIGHT_RESIZE_POLICY, "FILL_TO_PARENT");
...
int UtcDaliActorRaiseAboveDifferentParentsN(void)
{
  ...
  parentA.SetProperty(DevelActor::Property::WIDTH_RESIZE_POLICY, "FILL_TO_PARENT");
  parentA.SetProperty(DevelActor::Property::HEIGHT_RESIZE_POLICY, "FILL_TO_PARENT");
  parentB.SetProperty(DevelActor::Property::WIDTH_RESIZE_POLICY, "FILL_TO_PARENT");
  parentB.SetProperty(DevelActor::Property::HEIGHT_RESIZE_POLICY, "FILL_TO_PARENT");
...
int utcDaliActorPartialUpdate(void)
{
  ...
  // Aligned by 16
  clippingRect = BoundsInteger(0, 736, 64, 64); // in screen coordinates
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
  application.RenderWithPartialUpdate(damagedRects, clippingRect);
  DALI_TEST_EQUALS(clippingRect.x, glScissorParams.x, TEST_LOCATION);
  DALI_TEST_EQUALS(clippingRect.y, glScissorParams.y, TEST_LOCATION);
  ...
  // Aligned by 16
  clippingRect = BoundsInteger(0, 720, 80, 80); // in screen coordinates
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
  application.RenderWithPartialUpdate(damagedRects, clippingRect);
  DALI_TEST_EQUALS(clippingRect.x, glScissorParams.x, TEST_LOCATION);
  DALI_TEST_EQUALS(clippingRect.y, glScissorParams.y, TEST_LOCATION);
  ...
  DALI_TEST_EQUALS<BoundsInteger>(clippingRect, BoundsInteger(16, 720, 64, 64), TEST_LOCATION);
...
int utcDaliActorPartialUpdateSetProperty(void)
{
  ...
  clippingRect = BoundsInteger(0, 736, 64, 64); // new clipping rect size increased due to change in actor size
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
  application.RenderWithPartialUpdate(damagedRects, clippingRect);
  DALI_TEST_EQUALS(clippingRect.x, glScissorParams.x, TEST_LOCATION);
  DALI_TEST_EQUALS(clippingRect.y, glScissorParams.y, TEST_LOCATION);
...
int utcDaliActorPartialUpdateTwoActors(void)
{
  ...
  DirtyRectChecker(damagedRects, {BoundsInteger(64, 672, 64, 64), BoundsInteger(96, 592, 112, 112)}, true, TEST_LOCATION);

  // in screen coordinates, adaptor would calculate it using previous frames information
  BoundsInteger clippingRect = BoundsInteger(64, 592, 144, 192);
  application.RenderWithPartialUpdate(damagedRects, clippingRect);
  ...
  DirtyRectChecker(damagedRects, {BoundsInteger(64, 672, 64, 64)}, false, TEST_LOCATION);
...
int utcDaliActorPartialUpdateActorsWithSizeHint01(void)
{
  ...
  BoundsInteger clippingRect = BoundsInteger(16, 688, 96, 96);
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
  ...
  clippingRect = BoundsInteger(48, 688, 64, 64);
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
  ...
  clippingRect = BoundsInteger(0, 704, 80, 96);
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
...
int utcDaliActorPartialUpdateActorsWithSizeHint02(void)
{
  ...
  BoundsInteger clippingRect = BoundsInteger(32, 704, 64, 64);
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
  ...
  clippingRect = BoundsInteger(16, 688, 96, 96);
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
  ...
  clippingRect = BoundsInteger(16, 672, 112, 112);
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
...
int utcDaliActorPartialUpdateActorsWithSizeHint03(void)
{
  ...
  clippingRect = BoundsInteger(16, 688, 112, 112);
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
...
int utcDaliActorPartialUpdateAnimation01(void)
{
  ...
  // Aligned by 16
  expectedRect1 = BoundsInteger(0, 704, 96, 112); // in screen coordinates, includes 1 last frames updates
  expectedRect2 = BoundsInteger(0, 768, 32, 48);  // in screen coordinates, includes 1 last frames updates
...
int utcDaliActorPartialUpdateAnimation02(void)
{
  ...
  // Aligned by 16
  clippingRect = BoundsInteger(0, 768, 32, 48); // in screen coordinates, includes 1 last frames updates
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
  ...
  clippingRect = BoundsInteger(0, 768, 32, 48);
  application.RenderWithPartialUpdate(damagedRects, clippingRect);
...
int utcDaliActorPartialUpdateSkipRendering(void)
{
  ...
  // Aligned by 16
  expectedRect1 = BoundsInteger(0, 704, 96, 112); // in screen coordinates
...
int utcDaliActorPartialUpdateNotRenderableActor(void)
{
  ...
  // Aligned by 16
  BoundsInteger clippingRect = BoundsInteger(0, 752, 48, 48); // in screen coordinates
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
...
int utcDaliActorPartialUpdate3DTransform(void)
{
  ...
  // Aligned by 16
  BoundsInteger clippingRect1 = BoundsInteger(0, 752, 48, 48); // in screen coordinates
  BoundsInteger clippingRect2 = BoundsInteger(144, 608, 48, 48);
  DirtyRectChecker(damagedRects, {clippingRect1, clippingRect2}, true, TEST_LOCATION);

  BoundsInteger surfaceRect = BoundsInteger(0, 0, TestApplication::DEFAULT_SURFACE_WIDTH, TestApplication::DEFAULT_SURFACE_HEIGHT);
  application.RenderWithPartialUpdate(damagedRects, surfaceRect);

  damagedRects.clear();
  surfaceRect = BoundsInteger(0, 0, TestApplication::DEFAULT_SURFACE_WIDTH, TestApplication::DEFAULT_SURFACE_HEIGHT);
  application.PreRenderWithPartialUpdate(TestApplication::RENDER_FRAME_INTERVAL, nullptr, damagedRects);
  application.RenderWithPartialUpdate(damagedRects, surfaceRect);
  ...
  clippingRect2 = BoundsInteger(144, 592, 64, 64);
  DALI_TEST_EQUALS(damagedRects.size(), 1, TEST_LOCATION);
...
int utcDaliActorPartialUpdateUseTextureUpdateArea01(void)
{
  ...
  // Aligned by 16
  BoundsInteger clippingRect = BoundsInteger(0, 736, 64, 64); // in screen coordinates
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
  ...
  testNativeImage->SetUpdatedArea(Rect<uint32_t>(16, 16, 32, 32));
...
int utcDaliActorPartialUpdateUseTextureUpdateArea02(void)
{
  ...
  // Set updated area of native image
  testNativeImage1->SetUpdatedArea(Rect<uint32_t>(0, 0, 16, 16));
  testNativeImage2->SetUpdatedArea(Rect<uint32_t>(32, 0, 16, 16));
  ...
  // Aligned by 16
  clippingRect = BoundsInteger(0, 736, 64, 80); // in screen coordinates
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
...
int utcDaliActorPartialUpdateUseTextureUpdateArea03(void)
{
  ...
  // Update textures
  texture1.Upload(pixelData, 0u, 0u, 0u, 0u, 16u, 16u);
  texture2.Upload(pixelData, 0u, 0u, 32u, 0u, 16u, 16u);
  ...
  // Aligned by 16
  clippingRect = BoundsInteger(0, 720, 80, 96); // in screen coordinates
  DirtyRectChecker(damagedRects, {clippingRect}, true, TEST_LOCATION);
