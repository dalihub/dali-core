...
int UtcDaliHash(void)
{
  ...
  const std::string_view testStringView1(testString1);
  const std::string_view testStringView2(testString2);
  ...
  DALI_TEST_CHECK(Dali::CalculateHash(testString1) == Dali::CalculateHash(testStringView1));
  DALI_TEST_CHECK(Dali::CalculateHash(testString2) == Dali::CalculateHash(testStringView2));
  DALI_TEST_CHECK(Dali::CalculateHash(testString1, testString2) == Dali::CalculateHash(testStringView1, testStringView2));

  DALI_TEST_CHECK(Dali::CalculateHash(testString1) != Dali::CalculateHash(testStringView1.substr(0, testStringView1.size() - 1)));
...
int UtcDaliHashNegative(void)
{
  ...
  const std::string_view emptyStringView(emptyString);

  DALI_TEST_CHECK(Dali::CalculateHash(emptyString) != 0);
  DALI_TEST_CHECK(Dali::CalculateHash(emptyString, emptyString) != 0);
  DALI_TEST_CHECK(Dali::CalculateHash(emptyStringView) != 0);
  DALI_TEST_CHECK(Dali::CalculateHash(emptyStringView, emptyStringView) != 0);
  DALI_TEST_CHECK(Dali::CalculateHash(emptyString) == Dali::CalculateHash(emptyStringView));
...
int UtcDaliHashDaliBuffer02(void)
{
  ...
  DALI_TEST_CHECK(Dali::CalculateHash(testStringView) == Dali::CalculateHash(testBuffer2));
...
int UtcDaliHashWithTerminator(void)
{
  TestApplication application;

  tet_infoline("UtcDaliHashWithTerminator");

  const std::string testString1("uJoints[10]");
  const std::string testString2("uJoints[3]");
  ...
  DALI_TEST_CHECK(Dali::CalculateHash(testString1, terminator) == Dali::CalculateHash(testString2, terminator));
  DALI_TEST_CHECK(Dali::CalculateHash(testStringView1, terminator) == Dali::CalculateHash(testStringView2, terminator));
  DALI_TEST_CHECK(Dali::CalculateHash(testString1, terminator) == Dali::CalculateHash(testStringView2, terminator));

  const char invalidTerminator = '?';

  DALI_TEST_CHECK(Dali::CalculateHash(testString1) == Dali::CalculateHash(testString1, invalidTerminator));
  DALI_TEST_CHECK(Dali::CalculateHash(testString1) == Dali::CalculateHash(testStringView1, invalidTerminator));
