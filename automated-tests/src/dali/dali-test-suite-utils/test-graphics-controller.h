...
class TestGraphicsConfig : public Dali::Integration::GraphicsConfig
{
  public:
    TestGraphicsConfig()= default;
    ~TestGraphicsConfig() override = default;
    TestGraphicsConfig(const TestGraphicsConfig&) = delete;
    TestGraphicsConfig& operator=(const TestGraphicsConfig&) = delete;
    TestGraphicsConfig& operator=(TestGraphicsConfig&&) = delete;
    TestGraphicsConfig(TestGraphicsConfig&&) = delete;
...
public:
  ...
  {
    static TestGraphicsSyncImplementation blah;
    return blah;
  }
...
public:
  ...
  TestGraphicsConfig mGraphicsConfig;
