...
int UtcDaliTypeRegistryAnimatablePropertyRegistrationWithDefaultSetGetFunctionP01(void)
{
  TestApplication application;
  TypeRegistry    typeRegistry = TypeRegistry::Get();
  ...
  DALI_TEST_CHECK(!getPropertyCalled);
  DALI_TEST_EQUALS(customActor.GetProperty<float>(animatablePropertyIndex), animatablePropertyDefaultValue.Get<float>(), TEST_LOCATION);
  DALI_TEST_CHECK(getPropertyCalled);
  getPropertyCalled = false;
...
int UtcDaliTypeRegistryAnimatablePropertyRegistrationWithDefaultSetGetFunctionP02(void)
{
  TestApplication application;
  TypeRegistry    typeRegistry = TypeRegistry::Get();
  ...
  application.Render(50);
  DALI_TEST_EQUALS(0.25f, animation.GetCurrentProgress(), TEST_LOCATION);
  DALI_TEST_EQUALS(customActor.GetCurrentProperty<float>(animatablePropertyIndex), 11.25f, TEST_LOCATION);
  ...
  application.Render(100);
  DALI_TEST_EQUALS(0.75f, animation.GetCurrentProgress(), TEST_LOCATION);
  DALI_TEST_EQUALS(customActor.GetCurrentProperty<float>(animatablePropertyIndex), 13.75f, TEST_LOCATION);
...
int UtcDaliTypeRegistryAnimatablePropertyRegistrationWithDefaultSetGetFunctionN01(void)
{
  TestApplication application;
  TypeRegistry    typeRegistry = TypeRegistry::Get();
  ...
  try
  {
    AnimatablePropertyRegistration property1(customType1, "animPropName", ANIMATABLE_PROPERTY_REGISTRATION_START_INDEX - 1, true, &SetProperty, &GetProperty);
    tet_result(TET_FAIL);
  }
  catch(DaliException& e)
  {
  ...
  try
  {
    AnimatablePropertyRegistration property1(customType1, "animPropName", ANIMATABLE_PROPERTY_REGISTRATION_MAX_INDEX + 1, true, &SetProperty, &GetProperty);
    tet_result(TET_FAIL);
  }
  catch(DaliException& e)
  {
...
int UtcDaliTypeRegistryAnimatablePropertyRegistrationWithDefaultSetGetFunctionN02(void)
{
  TestApplication application;
  TypeRegistry    typeRegistry = TypeRegistry::Get();
  ...
  try
  {
    AnimatablePropertyRegistration property2(customType1, "animPropName2", ANIMATABLE_PROPERTY_REGISTRATION_START_INDEX + 1, Property::BOOLEAN, &SetProperty, &GetProperty);
    tet_result(TET_FAIL);
  }
  catch(DaliException& e)
  {
  ...
  try
  {
    AnimatablePropertyRegistration property3(customType1, "animPropName3", ANIMATABLE_PROPERTY_REGISTRATION_START_INDEX + 1, true, &SetProperty, &GetProperty);
    tet_result(TET_FAIL);
  }
  catch(DaliException& e)
  {
